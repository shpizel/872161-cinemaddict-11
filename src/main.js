 ...
 * Header
 *
 * состоит из логотипа и профайла
 */
...
const getMainNavigationHTML = () => `<nav class="main-navigation">
...
const getMainSorterHTML = () => `<ul class="sort">
  <li><a href="#" class="sort__button sort__button--active">Sort by default</a></li>
  <li><a href="#" class="sort__button">Sort by date</a></li>
  <li><a href="#" class="sort__button">Sort by rating</a></li>
</ul>`;

const getMainMenuHTML = () => `${getMainNavigationHTML()}\n${getMainSorterHTML()}`;


const getFilmCardHTML = () => {
  const variants = [`<article class="film-card">
  ...
  </article>`, `<article class="film-card">
  ...
  return getRandomChoice(variants);
};
...
const getMainFilmsSectionHTML = () => `<section class="films">
    <section class="films-list">
        ...
        <div class="films-list__container">
            ${Array.from({length: 5}, getFilmCardHTML)}
        </div>
    ...
    <section class="films-list--extra">
      ...
      <div class="films-list__container">
        ${Array.from({length: 2}, getFilmCardHTML)}
      </div>
...
setTimeout(() => render(getFilmDetailsPopupHTML(), footerNode, `afterend`), 2500);
